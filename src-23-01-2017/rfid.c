...
//        unsigned char keyB[] = {0x06,0x07,0x08,0x09,0x0a,0x0b} ;  // KEY B
        ...
        unsigned char write_data[32],read_data[32],blk_data[32],tg_det=0,tag_id[10];


//	 for(i=0; i<8; i++)  rfid_masterkey[i]=i;  rfid_masterkey[i]='\0'; // masterkey
	...
	if(tama_authenticate_mifare (1,Auth_block_addr,key,KEYA) !=0) // Transport key Configuration
          {
