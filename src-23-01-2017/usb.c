...
int usb_detect (void)
{
	...
	usbaret=usba_test();
   	...
   	{
     		lk_dispclr();
     		lk_disptext(2,1,"USB HOST Information",0);
...
int usba_test (void)
{
	char ven[20]="",ven1[20]="",prod[20]="",prod1[20],chr[80]="",flag=0,i,j;
	...
	lk_dispclr();
        ...
        lk_disptext(3,1,"1.USB_A1",0);
        lk_disptext(4,1,"2. USB_A2",0);
        value=lk_getkey();
		...
		if(flag==0)
            	{
               		...
               		lk_dispclr();
               		lk_disptext(3,2,"NO USB DEVICE FOUND A",0);
               		lk_getkey();
			return 0;
		}   
	...
	else if (value==2)
	{
       		if(flag==1 || flag==0)
        	{
        		//fprintf(stderr,"NO USB DEVICE FOUND");
        		lk_dispclr();
			lk_disptext(3,2,"NO USB DEVICE FOUND B ",0);
           		lk_getkey();
			return 0;
       		}
