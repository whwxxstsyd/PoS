...
int Local_test (void)
{
        ...
        strcpy(menu.menu[0],"1.RS232" );
        strcpy(menu.menu[1],"2.USB_B");
               ...
               switch(opt)
                {
                    ...
                    case ENTER:
                       ...
                       case 1: case 2:
                        ...
                        switch (selItem+1)
                         {
                           case 1: 	Download_images_rs232(); break;
				  	break;	
...
int Download_images_rs232(void)
{
        int opt=0;
        MENU_T menu;
        char event;
 ...
 int download_kernel_rs232(void) 
  {
	int ret;
    ...
    lk_disptext(5,1,"ENTER->YES   X->NO",0);
...
while(1)
 ...
 int download_ramdisk_rs232 (void)
  {
	int ret;
    lk_dispclr();
    lk_disptext (3,4,"Send File From",0);
    ...
    lk_disptext (1,3,"Rootfs Download",1);
    printf("\nNew Rootfs Downloading ...\n");
	while(1)
        {
    ...
    printf ("\nNew Rootfs downloaded from RS232\n");


    lk_dispclr(); 	
    lk_disptext (2,1,"Fusing Rootfs ...",0) ;
    printf("\nWriting Rootfs To Flash\n");
...
int download_application_rs232 (void)
  {
	int ret;
     lk_dispclr();
     lk_disptext (3,4,"Send File From",0);
...
int jffs2_upload_download_rs232(void)
 {
...
int jffs2_download_rs232 (void)
  {
	int ret ;
    system("mkdir /mnt/tmp/jffs2");
    chdir("/mnt/tmp/jffs2/");
    lk_dispclr();
    lk_disptext (3,4,"Send File From",0);
    lk_disptext (4,7,"PC Side",0);
...
while(1)
    ...
    chdir("/");
    system("cp /mnt/tmp/jffs2/* /mnt/jffs2/");
    system("rm -Rf /mnt/tmp/jffs2");	
    lk_dispclr();
          ...
          switch(opt)
                ...
                case ENTER:
                  case 1: case 2: case 3: case 4:
                        ...
                        case 1: download_kernel_usbb();        break;

                        case 2: download_ramdisk_usbb();       break;

                        case 3: download_application_usbb();   break;
			
			case 4: download_jffs2_usbb(); break; 
                         }
                }
        }
 return 0;
...
int download_kernel_usbb (void)
 ...
 lk_disptext(5,1,"ENTER->YES   X->NO",0);
    ...
    printf ("\nNew Kernel downloading ...\n") ;
    system ("/home/usbkermit -ira /mnt/tmp/kernel.img");
 ...
 int download_ramdisk_usbb (void)
  {
 ...
 lk_disptext(5,1,"ENTER->YES   X->NO",0);
    ...
    system ("/home/usbkermit -ira /mnt/tmp/ramdisk.img");
...
int download_application_usbb (void)
   {	int ret;
     lk_dispclr();
     lk_disptext (3,4,"Send File From",0);
     lk_disptext (4,7,"PC Side",0);
 lk_disptext(5,1,"ENTER->YES   X->NO",0);
     ...
     system ("/home/usbkermit -ira /mnt/tmp/app.img");
     printf ("\nNew Application downloaded from usb-b\n");
...
if(!i)
 {
  ...
  return -1;
    ...
    while(1)
     ...
     lk_dispclr();
     lk_disptext (3,3,"Uploading File ..",1);
     sprintf(upload_com,"/home/usbkermit -is /mnt/jffs2/%s",upload_file);
     system(upload_com);
     lk_dispclr();
     lk_disptext (3,4,"File Uploaded",1);
     lk_disptext (5,4,"Press Any Key",0);
