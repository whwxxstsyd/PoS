...
int  mass_storage ( void )
{
	...
	if (key==1  && flag==1 ) 
		...
		{	sleep(5); //this for after usb poweron system need time to update device related infomation
...
int usb_upload_download_rs232(void)
 {
