...
{
case -1: lk_dispclr();
	 lk_disptext(2,5,"device not opened",1);
	 break;

case -2: lk_dispclr();
	 lk_disptext(2,5,"length error",1);
	 break;

case -3: lk_dispclr();
         lk_disptext(2,5,"NO Paper",1);
         break;

case -4: lk_dispclr();
         lk_disptext(2,5,"Low Battery",1);
         break;

case -5: lk_dispclr();
         lk_disptext(2,5,"Max temp",1);
         break;

case -6: lk_dispclr();
         lk_disptext(2,5,"No Lines",1);
         break;

case -7: lk_dispclr();
         lk_disptext(2,5,"WRITE_ERROR",1);
         break;
...
/*
  ...
  int bmpprint_test(void)
   {
      ...
      char bmpbuff[30000]; 
        ...
        lk_dispclr();
        lk_disptext(3,5,"Printing Logo",1);
  ...
  int motor_test(void)
   ...
   int font_test(void)
    {
        unsigned char i,str[256]="abcdefghijklmnopqrstuvwxyzabcdefghijklmnopABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOP012345678901234567890~!@#$%^&*()_+|=-{}:?>";
        int ret;       
        if(prn_paperstatus()!=0)
         {
            lk_dispclr();
          ...
          //while(1){ 
            for(i=0;i<2;i++)
             {
              ret=prn_write_text(str,sizeof(str),1); 
	      returncheck(ret);	
...
int prepare_bmp(unsigned char *bmpbuf,unsigned char *data,int len)
{
    int i,j;
    for(i=0,j=0;i<len;i++)
     {
